...
Step-by-step commands and reference detail for the Gourgouthakas cave analysis.
See [`README.md`](README.md) for the overview; this file is the long-form log.
...
## GTDB placement and depth figures
